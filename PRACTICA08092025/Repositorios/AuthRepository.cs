...
namespace AuthApi.Repositories
{
    public class AuthRepository : IAuthService
    {
        ...
        public async Task<UsuariosRespuestaDTO> RegistrarAsync(UsuariosRegistroDTO dto)
        {
            ...
            return new UsuariosRespuestaDTO
            {
                Id = usuario.Id,
        ...
        public async Task<UsuariosRespuestaDTO> LoginAsync(UsuariosLoginDTO dto)
        {
